...
public class LabelledParameterized extends Parameterized
{
	...
	private void initializeLabels() throws Exception
	{
	...
	private Collection<Object[]> getParameterArrays4_3() throws Exception
	{
		...
		for (Method method : methods)
		{
			...
			if (parametersMethod != null)
				throw new Exception("Only one method should be annotated with @Parameters");
	...
	{
		Object[][] methodCalls = new Object[][] { new Object[] { "getTestClass" }, new Object[] { "getAnnotatedMethods", Class.class, Parameters.class }, new Object[] { "get", int.class, 0 },
