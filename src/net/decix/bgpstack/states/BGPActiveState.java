...
/**
 * This class represents the BGP ACTIVE state
 * 
 * @author sspies
 * 
 */
public class BGPActiveState implements BGPState
{

	private BGPPeerFSM fsm;

	private static Logger logger = Logger.getLogger(BGPActiveState.class.getCanonicalName());
	
	/**
	 * instantiates a new BGPActiveState object
	 * 
	 * @param fsm the finite state machine
	 */
	public BGPActiveState(BGPPeerFSM fsm)
	{
		this.fsm = fsm;
